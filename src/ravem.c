...
0xCA, 0xFE, 0xBA, 0xBE, 0x00, 0x00, 0x00, 0x32, 0x00, 0x35, 0x0A, 0x00, 0x0F, 
	...
	0x00, 0x0C, 0x00, 0x21, 0x0A, 0x00, 0x1F, 0x00, 0x22, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
	0x03, 0xE8, 0x0A, 0x00, 0x0C, 0x00, 0x23, 0x07, 0x00, 0x24, 0x08, 0x00, 0x25, 0x07, 0x00, 0x26, 
	0x0A, 0x00, 0x0C, 0x00, 0x1B, 0x0A, 0x00, 0x0C, 0x00, 0x27, 0x07, 0x00, 0x28, 0x01, 0x00, 0x06, 
	...
	0x0B, 0x54, 0x68, 0x72, 0x65, 0x61, 0x64, 0x20, 0x74, 0x65, 0x73, 0x74, 0x01, 0x00, 0x05, 0x68, 
	0x6F, 0x67, 0x65, 0x31, 0x0C, 0x00, 0x34, 0x00, 0x11, 0x01, 0x00, 0x10, 0x6A, 0x61, 0x76, 0x61, 
	...
	0x73, 0x74, 0x61, 0x72, 0x74, 0x00, 0x20, 0x00, 0x0C, 0x00, 0x0F, 0x00, 0x00, 0x00, 0x00, 0x00, 
	...
	0xB2, 0x00, 0x02, 0x12, 0x0B, 0xB6, 0x00, 0x06, 0xBB, 0x00, 0x0C, 0x59, 0xB7, 0x00, 0x0D, 0x4C, 
	0xBB, 0x00, 0x0C, 0x59, 0xB7, 0x00, 0x0D, 0x4D, 0x2B, 0xB6, 0x00, 0x0E, 0x2C, 0xB6, 0x00, 0x0E, 
	0xB1, 0x00, 0x00, 0x00, 0x01, 0x00, 0x13, 0x00, 0x00, 0x00, 0x1A, 0x00, 0x06, 0x00, 0x00, 0x00, 
	0x10, 0x00, 0x08, 0x00, 0x12, 0x00, 0x10, 0x00, 0x13, 0x00, 0x18, 0x00, 0x15, 0x00, 0x1C, 0x00, 
	0x16, 0x00, 0x20, 0x00, 0x17, 0x00, 0x01, 0x00, 0x19, 0x00, 0x00, 0x00, 0x02, 0x00, 0x1A, 0x00, 
	0x00, 0x00
};
...
int getIntegerFromOperandStack(class_st cl){
	...
	if(cl.op_stack_type[i] == Stack_ConstantPool){ // Const_Integer
		...
		if((cp.tab == CONSTANT_Long)||(cp.tab == CONSTANT_Double))			
			return (cp.index2);
		else
			return (cp.index);
	}
	...
	int now_code = 0;
		...
		switch(*bc_seek(now_code,1)){
			...
			case JAVA_invokevirtual:
				cl = invokevirtual_callFunction(cl,seekNameAndType_name((*bc_seek(now_code + 1, 1) << 8) + *bc_seek(now_code + 2, 1)).stack_pt);
				now_code = now_code + 3;
				break;

			case JAVA_invokestatic:
				cl = invokestatic_callFunction(cl,seekNameAndType_name((*bc_seek(now_code + 1, 1) << 8) + *bc_seek(now_code + 2, 1)).stack_pt);
				now_code = cl.bc_offset + cl.code_offset;  
				break;
